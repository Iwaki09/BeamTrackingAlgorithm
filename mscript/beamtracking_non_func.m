clc
output_name = 'curve_test2_2dim';
val = getenv("TERM");

addpath('/opt/homebrew/Cellar/sumo/1.19.0/share/sumo/tools/contributed/traci4matlab/');
scenarioPath = '/Users/iwakiryo2/Documents/01Research/01Source/BeamTrackingAlgorithm/datasource/curve_r60.sumocfg';
% [traciVersion,sumoVersion] = traci.start(['sumo -c ' '"' scenarioPath '"']);
[traciVersion, sumoVersion] = traci.start(['sumo -c "' scenarioPath '" --remote-port 8813']);
f_plot = 0
